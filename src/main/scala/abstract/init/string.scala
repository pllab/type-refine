...
object InitString {
  ...
  val String_Obj = createFunctionObj(
    Native(
      (selfAddr: BValue, argArrayAddr: BValue, x: Var, ρ: Env, σ: Store, ß:Scratchpad, κ: KStack, τ: Trace) ⇒ {
        ...
        val arg_preconv = (argsArray(SConstNum("0")) getOrElse Str.inject(Str.α("")), StringHint)
    ...
    ExternMap(exactnotnum = Map(
      ...
      SConstNotNum("prototype") → Address.inject(String_prototype_Addr),
      SConstNotNum("fromCharCode") → Address.inject(String_fromCharCode_Addr)
    )), cls = CString_Obj
  )
  ...
  // String proto
  val String_prototype_Obj = createObj(
    ExternMap(exactnotnum = Map(
      SConstNotNum("charAt") → Address.inject(String_prototype_charAt_Addr), // TODO
      SConstNotNum("charCodeAt") → Address.inject(String_prototype_charCodeAt_Addr), // TODO
      SConstNotNum("concat") → Address.inject(String_prototype_concat_Addr), // TODO
      SConstNotNum("indexOf") → Address.inject(String_prototype_indexOf_Addr), // TODO
      SConstNotNum("lastIndexOf") → Address.inject(String_prototype_lastIndexOf_Addr), // TODO
      SConstNotNum("localeCompare") → Address.inject(String_prototype_localeCompare_Addr), // TODO
      SConstNotNum("match") → Address.inject(String_prototype_match_Addr),
      SConstNotNum("replace") → Address.inject(String_prototype_replace_Addr), // TODO
      SConstNotNum("search") → Address.inject(String_prototype_search_Addr), // TODO
      SConstNotNum("slice") → Address.inject(String_prototype_slice_Addr), // TODO
      SConstNotNum("split") → Address.inject(String_prototype_split_Addr), // TODO
      SConstNotNum("substr") → Address.inject(String_prototype_substr_Addr), // TODO
      SConstNotNum("substring") → Address.inject(String_prototype_substring_Addr), // TODO
      SConstNotNum("toLocaleLowerCase") → Address.inject(String_prototype_toLocaleLowerCase_Addr), // TODO
      SConstNotNum("toLocaleUpperCase") → Address.inject(String_prototype_toLocaleUpperCase_Addr), // TODO
      SConstNotNum("toLowerCase") → Address.inject(String_prototype_toLowerCase_Addr), // TODO
      SConstNotNum("toString") → Address.inject(String_prototype_toString_Addr),
      SConstNotNum("toUpperCase") → Address.inject(String_prototype_toUpperCase_Addr), // TODO
      SConstNotNum("trim") → Address.inject(String_prototype_trim_Addr), // TODO
      SConstNotNum("valueOf") → Address.inject(String_prototype_valueOf_Addr)
    )),
    Map(
  ...
  val String_prototype_charAt_Obj =
    constFunctionObj(ezStrSig(NumberHint), Str.inject(STop))
  ...
  val String_prototype_split_Obj =
    usualFunctionObj(ezStrSig(StringHint, NumberHint)) {
      case (_, σ, τ) ⇒ {
        val (arr_a_bv, σ_) = InitRegExp.allocUnknownStringArray(σ, τ)
        Set((arr_a_bv, σ_))
      }
    }
